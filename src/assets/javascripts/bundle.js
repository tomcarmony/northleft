...
$('.inquiry-options__item').on('click', function() {
...
$('#submit').on('click', function(e) {
  ...
  form.validate();
  if (form.valid()) {
    $(this).addClass('fly-away').one('webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend', function() {
    });
  }
});

},{"./vendor/validate":3,"jquery":1}],3:[function(require,module,exports){
